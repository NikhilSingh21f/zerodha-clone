          ...
          <div className="row align-items-center signup-content p-5 mt-5">
            ...
            <div className="col-lg-5">
              <div className="signup-form">
                <h3>Signup now</h3>
                <p className="abc text-muted fs-5">Or track your existing application</p>
                <form onSubmit={handleSignup}>
                  ...
                  <button type="submit" className="btn btn-primary signup-button w-50 mt-2">Sign Up</button>
                </form>
                <p className="abc mt-3">
                  Already have an account?
                  <button type="button" onClick={goToLogin} className="btn btn-link text-decoration-none p-2">Login</button>
                </p>
              </div>
