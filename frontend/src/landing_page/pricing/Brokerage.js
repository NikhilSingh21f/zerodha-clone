            ...
            <div className='row p-5 mt-5 text-center border-top'>
                <div className='col-8 p-4'>
                    ...
                    <ul style={{ textAlign: "left", lineHeight: "2.5" }} className='text-muted'>
                        ...
                        <li> Digital contract notes be sent via e-mail. </li>
                        <li>physical copies of contract notes,if required,shall be charged ₹20 per contract note.Couier charges apply</li>
                ...
                <div className='col-4 p-4'>
                    <a href='' style={{ textDecoration: "none" }}><h3 className='fs-5'>List of a charges</h3></a>
                </div>
            </div>
        </div>
    );
